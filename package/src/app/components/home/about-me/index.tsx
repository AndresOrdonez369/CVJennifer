          ...
          <div className="container">
            ...
            <div className="pt-10 xl:pt-16 flex gap-10 items-center justify-between">
              ...
              <div className="w-full lg:max-w-2xl flex-1">
                <p>
                  With a solid track record in marketing, retail operations
                  and business strategy, I'm passionate about driving growth
                  and improving processes through creative problem-solving and
                  data-driven decisions. I've led customer-centric initiatives,
                  digital transformation projects and cross-functional
                  programs that boost efficiency and elevate brand presence.
                </p>

                <div className="grid grid-cols-3 py-10 xl:py-16 gap-5 border-b border-gray-300">
                  {[
                    { count: "4+", label: "Years of experience" },
                    { count: "85%", label: "Efficiency Gains Delivered" },
                    { count: "1000+", label: "SKUs Managed" },
                  ].map((item, i) => (
                    <div key={i}>
                      <h3>{item.count}</h3>
                ...
                <div className="pt-8 xl:pt-14 flex flex-col sm:flex-row items-center gap-4">
                  ...
                  <div className="flex flex-wrap justify-center items-center gap-2.5">
                    {["English (Advanced)", "Spanish (Native)"].map((lang, index) => (
