      ...
      <div className="bg-muted">
        <div className="container">
          <div className="py-16 xl:py-32 ">
            ...
            <p className="text-muted-foreground max-w-3xl mb-9 md:mb-16">
              Here's a selection of projects I've led or contributed to —
              ranging from retail process improvements to marketing campaigns
              and digital tools. Each one reflects my focus on efficiency,
              customer experience, and business growth.
            </p>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-6 xl:gap-y-12">
